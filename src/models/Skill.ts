  ...
  constructor(id: string, value?: number) {
    ...
    switch(this.id) {
      case SkillId.TAL_1: {
        ...
        this.attributes = [
          new Attribute(AttributeId.ATTR_1), 
          new Attribute(AttributeId.ATTR_2), 
          new Attribute(AttributeId.ATTR_7)]
        break
      }
      case SkillId.TAL_2: {
        ...
        this.attributes = [
          new Attribute(AttributeId.ATTR_1), 
          new Attribute(AttributeId.ATTR_4), 
          new Attribute(AttributeId.ATTR_8)]
        break
      }
      case SkillId.TAL_3: {
        this.name = "Klettern"
        ...
        this.attributes = [
          new Attribute(AttributeId.ATTR_1), 
          new Attribute(AttributeId.ATTR_7), 
          new Attribute(AttributeId.ATTR_6)]
        break
      }
      case SkillId.TAL_4: {
        ...
        this.attributes = [
          new Attribute(AttributeId.ATTR_7), 
          new Attribute(AttributeId.ATTR_7), 
          new Attribute(AttributeId.ATTR_5)]
        break
      }
      case SkillId.TAL_5: {
        this.name = "Kraftakt"
      ...
      case SkillId.TAL_9: {
        ...
        this.category = SkillCategory.Koerpertalente
        this.attributes = [
          new Attribute(AttributeId.ATTR_3), 
          new Attribute(AttributeId.ATTR_4), 
          new Attribute(AttributeId.ATTR_5)]
        break
      }
